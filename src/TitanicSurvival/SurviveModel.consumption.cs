...
namespace TitanicSurvival
{
    ...
    {
        /// <summary>
        /// model input class for SurviveModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for SurviveModel.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("SurviveModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Survived");
            if (labelColumn == null)
            {
                throw new Exception("Survived column not found. Make sure the name searched for matches the name in the schema.");
            }
