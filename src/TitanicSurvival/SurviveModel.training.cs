...
{
    public partial class SurviveModel
    {
        public const string RetrainFilePath =  @"D:\Data\titanic\train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"Pclass", @"Pclass"),new InputOutputColumnPair(@"Sex", @"Sex"),new InputOutputColumnPair(@"Age", @"Age")})      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Pclass",@"Sex",@"Age"}))      
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Survived",inputColumnName:@"Survived",addKeyValueAnnotationsAsText:false))      
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=20,NumberOfTrees=4,MaximumBinCountPerFeature=254,FeatureFraction=1,LearningRate=0.09999999999999998,LabelColumnName=@"Survived",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"Survived"))      
